                        ...
                        <div class="col-md-12">
                           ...
                           <section class="msger">
                                    <header class="msger-header">
                                        ...
                                        <i class="fas fa-comment-alt"></i> {{ $receiverdata->first_name }} {{ $receiverdata->last_name }}
                                        </div>
                                    ...
                                    @if(isset($chatroom) && count($chatroom) > 0 )
                                    ...
                                    @endif
                                     ...
                                     @else
                                       <p class="text-center text-danger">Your chat is empty.</p>
                                     @endif
...
<script>
//  $(".msger-chat").stop().animate({ scrollTop: $(".msger-chat")[0].scrollHeight}, 1000);
 $(".msger-chat").animate({ scrollTop: 20000000 }, "slow");
        ...
        $('.msger-send-btn').click(function(){
            //   alert()
              if($('.msger-input').val() !=''){
                     ...
                     $.ajax({
                       url:"{{ url('doctor/send-msg')}}",
                       method:'POST',
                       data:{receiver_id:$('#receiver_id').val(),message:$('.msger-input').val()},
    ...
    $(document).ready(function(){
        ...
        function getMessage(){
          ...
          function getSeenMessage(){
            ...
            $.ajax({
                 url:"{{ url('doctor/get-seen-status')}}",
                 method:'POST',
                 success:function(response){
                     if(response==1){
                          $(".msger-chat").animate({ scrollTop: 20000000 }, "slow");
