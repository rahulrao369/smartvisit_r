               ...
               <form  id="register_form">
                ...
                <div class="formstart">
                    ...
                    <div class="form-group soapradio">
                         ...
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="designradio ">
                                    <label class="paymentradio notiradio" for="male">Male
                             ...
                             <div class="col-md-6">
                                 <div class="designradio">
                                    <label class="paymentradio notiradio" for="female">Female
                         ...
                         <!--<div class="designradio">-->
                         <!--   <label class="paymentradio notiradio">Prefer not to say-->
                         <!--       <input type="radio" name="gender" value="3" id="gender">-->
                         <!--       <span class="checkmark"></span>-->
                         <!--     </label>-->
                         <!--</div>-->
                    ...
                    <div class="form-group">
                        <p style="margin: 0; font-size: 14px; font-weight: 500; color: #444; text-align: left;"> <label for="checkboxs"> <input id="checkboxs" style="position: relative; top: 2px; margin-right: 5px;" type="checkbox" /> I Agree to the Patient <a href="#">Terms of Service </a> and <a href="#">Privacy Statement</a> </label> </p>
                        <p class="text-danger checkboxs-error"></p>
                    </div>

                    <div class="submitwrapper">
                        <!--<a href="index.html">-->
                            <button type="button" class="editbtn patient_register">Continue</button>
                        <!--</a>-->
                    </div>
