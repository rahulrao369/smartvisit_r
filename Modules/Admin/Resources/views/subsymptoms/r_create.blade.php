            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="post" action="{{ url('admin/create-subsymptoms')}}" novalidate>
                               @csrf
                                 ...
                                 <div class="row col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label>Category</label>
                                          <input type="text" class="form-control" name="name" value="{{ $subsymptom->name }}" readonly="">
                                           <input type="hidden" class="form-control" name="category" value="{{ $subsymptom->id }}" readonly="">
