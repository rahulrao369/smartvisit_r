            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="post" action="{{ url('admin/sub-symptoms-update')}}" novalidate>
                               @csrf
                                 ...
                                 <div class="row col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label>Category</label>
                                          <input type="text" class="form-control" name="name" value="{{ $subsymptom_list->name }}" readonly="">
                                ...
                                <div class="row col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label>Name</label>
                                        <input type="text" class="form-control" name="name" value="{{ $subsymptom->name }}">
                                        <input type="hidden" class="form-control" name="id" value="{{ base64_encode($subsymptom->id) }}" readonly="">
                                        @if($errors->has('name'))
                                        <p class="text-danger">{{ $errors->first('name') }}</p>
                                        @endif
                                        
                                        @if(session()->has('exist_name'))
                                        <p class="text-danger">{{ session()->get('exist_name') }}</p>
                                        @endif
