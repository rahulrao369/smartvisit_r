                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <div class="">
                            ...
                            <div class="body">
                                <form id="basic-form" method="post" action="{{ url('admin/patient-store')}}" novalidate>@csrf
                                    ...
                                    <div class="row col-sm-12">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            @endif
                                             ...
                                             @if(session()->has('eemail'))
                                            <p class="text-danger">{{ session()->get('eemail') }}</p>
                                            @endif
                                            </div>
                                    </div>
                                    <div class="row col-sm-12">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <p class="text-danger">{{ $errors->first('phone') }}</p>@endif  @if(session()->has('ephone'))
                                            <p class="text-danger">{{ session()->get('ephone') }}</p>
                                            @endif</div>
